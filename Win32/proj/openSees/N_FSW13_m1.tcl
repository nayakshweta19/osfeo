...
set beamType nonlinearBeamColumn
...
nDMaterial FAReinforcedConcretePlaneStress 15  0.02 11 12 13 14 [expr 0.0*$pi]  [expr 0.5*$pi]   $rou1 $rou2  $wfc $wfy $wE 0.002
...
#  test NormDispIncrVaryIter 0.01 14 5 numStep 100 400 300 400 600 800 1200 1600 2050 2500 2960 3470 1000 10 numIter 100 0 0 0 0 100 0 0 0 0 0 0 0 0 
  test NormDispIncr 1.0e-10 10 0
...
# Create a recorder to monitor nodal displacements
  recorder Node -file P_FSW13_n13.out -time -node 13 -dof 1 disp
