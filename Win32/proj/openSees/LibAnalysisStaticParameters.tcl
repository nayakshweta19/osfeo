...
#          NewtonLineSearch -- 
#          KrylovNewton -- algorithm KrylovNewton <-iterate $tangIter> <-increment $tangIncr> <-maxDim $maxDim>
#          BFGS -- 
#          Broyden -- 
variable algorithmTypeStatic KrylovNewton -maxDim 200
