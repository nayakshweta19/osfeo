...
set cmd "block2D $nx $ny  1 1 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 0.0E+0*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 0.00E+0*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 0.00E+0*$in/$mm]
    3   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    4   [expr 0.0E+0*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
}"
eval $cmd;
#fix  2  0  1  0;   fix  2  0  1  0;   fix  2  0  1  0;   fix  2  0  1  0;

#element  quad3d       2       2       7       8       3     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 21 11 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 0.0E+0*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    3   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    4   [expr 0.0E+0*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
}"
eval $cmd;
#element  quad3d       3       3       8       9       4     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 41 21 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 0.0E+0*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    3   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
    4   [expr 0.0E+0*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
}"
eval $cmd;
#element  quad3d       4       4       9      10       5     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 61 31 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 0.0E+0*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
...
set cmd "block2D $nx $ny 81 41 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 0.00E+0*$in/$mm]
    2   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 0.00E+0*$in/$mm]
    3   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    4   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
}"
eval $cmd;
#element  quad3d       6       7      12      13       8     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 101 51 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    2   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    3   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    4   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
}"
eval $cmd;
#element  quad3d       7       8      13      14       9     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 121 61 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    2   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    3   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
    4   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
}"
eval $cmd;
#element  quad3d       8       9      14      15      10     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 141 71 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
    2   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
    3   [expr 5.4E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.88E+2*$in/$mm]
    4   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.88E+2*$in/$mm]
}"
eval $cmd;
...
set cmd "block2D $nx $ny 161 81 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 7.8E+1*$in/$mm]  [expr 0.00E+0*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 0.00E+0*$in/$mm]
    3   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    4   [expr 2.7E+1*$in/$mm]  [expr 7.8E+1*$in/$mm]  [expr 7.20E+1*$in/$mm]
}"
eval $cmd;
#element  quad3d      10      17       7       8      18     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 181 91 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 7.8E+1*$in/$mm]  [expr 7.20E+1*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 7.20E+1*$in/$mm]
    3   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    4   [expr 2.7E+1*$in/$mm]  [expr 7.8E+1*$in/$mm]  [expr 1.44E+2*$in/$mm]
}"
eval $cmd;
#element  quad3d      11      18       8       9      19     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 201 101 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 7.8E+1*$in/$mm]  [expr 1.44E+2*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 1.44E+2*$in/$mm]
    3   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
    4   [expr 2.7E+1*$in/$mm]  [expr 7.8E+1*$in/$mm]  [expr 2.16E+2*$in/$mm]
}"
eval $cmd;
#element  quad3d      12      19       9      10      20     $t  "PlaneStress"   15;
set cmd "block2D $nx $ny 221 111 quad3d  \" $t  PlaneStress  15 \"  {
    1   [expr 2.7E+1*$in/$mm]  [expr 7.8E+1*$in/$mm]  [expr 2.16E+2*$in/$mm]
    2   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.16E+2*$in/$mm]
    3   [expr 2.7E+1*$in/$mm]  [expr 0.0E+0*$in/$mm]  [expr 2.88E+2*$in/$mm]
