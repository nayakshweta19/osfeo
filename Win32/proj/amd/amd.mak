# Microsoft Developer Studio Generated NMAKE File, Based on amd.dsp
!IF "$(CFG)" == ""
CFG=amd - Win32 Debug
!MESSAGE No configuration specified. Defaulting to amd - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "amd - Win32 Release" && "$(CFG)" != "amd - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "amd.mak" CFG="amd - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "amd - Win32 Release" (based on "Win32 (x86) Static Library")
!MESSAGE "amd - Win32 Debug" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
CLEAN :
	...
	-@erase "$(OUTDIR)\amd.lib"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /Fp"$(INTDIR)\amd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\amd.bsc" 
BSC32_SBRS= \
	
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"$(OUTDIR)\amd.lib" 
LIB32_OBJS= \
	"$(INTDIR)\dasum.obj" \
	"$(INTDIR)\daxpy.obj" \
	"$(INTDIR)\dcabs1.obj" \
...
"$(OUTDIR)\amd.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<

!ELSEIF  "$(CFG)" == "amd - Win32 Debug"
...
CPP=cl.exe
CPP_PROJ=/nologo /MLd /W3 /GX /Od /I "..\..\amd" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /Fp"$(INTDIR)\amd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
!INCLUDE "amd.dep"
!ELSE 
!MESSAGE Warning: cannot find "amd.dep"
!ENDIF 
!ENDIF 
