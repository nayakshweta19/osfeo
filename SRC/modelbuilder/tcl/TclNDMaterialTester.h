...
#ifndef TclNDMaterialTester_h
#define TclNDMaterialTester_h
...
class TclNDMaterialTester : public TclModelBuilder
{
  public:
    TclNDMaterialTester(Domain &theDomain,Tcl_Interp *interp, int count=1);
    ~TclNDMaterialTester();    
