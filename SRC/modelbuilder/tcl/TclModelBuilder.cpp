...
//////////////////////////////////////////////////////////////////////////
int
TclCommand_addBiaxialFiber(ClientData clientData,
	             Tcl_Interp *interp,
				 int argc,
				 TCL_Char **argv);
int
TclCommand_addTriaxialFiber(ClientData clientData,
	             Tcl_Interp *interp,
	             int argc,
	             TCL_Char **argv);
int
TclCommand_addBiaxialLayer(ClientData clientData,
	             Tcl_Interp *interp,
				 int argc,
				 TCL_Char **argv);
int
TclCommand_addTriaxialLayer(ClientData clientData,
	             Tcl_Interp *interp,
	             int argc,
	             TCL_Char **argv);
//////////////////////////////////////////////////////////////////////////
...
//Neallee
extern int
TclCommand_add2dFiber (ClientData clientData, Tcl_Interp *interp,
		     int argc, TCL_Char **argv,
		     TclModelBuilder *theTclBuilder);
extern int
TclCommand_add3dFiber (ClientData clientData, Tcl_Interp *interp,
		     int argc, TCL_Char **argv,
		     TclModelBuilder *theTclBuilder);
extern int
TclCommand_add2dLayer (ClientData clientData, Tcl_Interp *interp,
		     int argc, TCL_Char **argv,
		     TclModelBuilder *theTclBuilder);
extern int
...
// End PRC
  ...
  Tcl_CreateCommand(interp, "fiber", TclCommand_addRemoFiber,
		    (ClientData)NULL, NULL);    
  //Neallee
  Tcl_CreateCommand(interp, "fiber2d", TclCommand_addBiaxialFiber,
	        (ClientData)NULL, NULL);
  Tcl_CreateCommand(interp, "fiber3d", TclCommand_addTriaxialFiber,
	        (ClientData)NULL, NULL);
...
//Neallee
int
TclCommand_addBiaxialFiber(ClientData clientData, Tcl_Interp *interp, int argc,   
			   TCL_Char **argv)
{
  return TclCommand_add2dFiber(clientData, interp, argc,argv,
				  theTclBuilder);
}

int
TclCommand_addTriaxialFiber(ClientData clientData, Tcl_Interp *interp, int argc,   
			   TCL_Char **argv)
{
  return TclCommand_add3dFiber(clientData, interp, argc,argv,
				  theTclBuilder);
}

int
TclCommand_addBiaxialLayer(ClientData clientData, Tcl_Interp *interp, int argc,   
			   TCL_Char **argv)
{
  return TclCommand_add2dLayer(clientData, interp, argc,argv,
				  theTclBuilder);
}

int
TclCommand_addTriaxialLayer(ClientData clientData, Tcl_Interp *interp, int argc,   
			   TCL_Char **argv)
{
  return TclCommand_add3dLayer(clientData, interp, argc,argv,
				  theTclBuilder);
}
