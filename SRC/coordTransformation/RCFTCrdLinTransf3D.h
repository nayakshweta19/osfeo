...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/coordTransformation/RCFTCrdLinTransf3D.h,v $
...
#ifndef RCFTCrdLinTransf3D_h
#define RCFTCrdLinTransf3D_h

#include <CrdTransf.h>
#include <Vector.h>
#include <Matrix.h>

class RCFTCrdLinTransf3D: public CrdTransf
{
  public:
    RCFTCrdLinTransf3D (int tag, const Vector &vecInLocXZPlane);
