...
Matrix RCFTCrdTransf3D::Tlg(12, 12);
Matrix RCFTCrdTransf3D::kg(12, 12);
...
void
RCFTCrdTransf3D::compTransfMatrixLocalGlobal(Matrix &Tlg)
{
...
CrdTransf *
RCFTCrdTransf3D::getCopy3d(void)
{
...
const Matrix &
RCFTCrdTransf3D::getGlobalMatrixFromLocal(const Matrix &ml)
{
