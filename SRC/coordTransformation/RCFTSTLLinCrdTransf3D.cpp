...
Matrix RCFTSTLLinCrdTransf3D::Tlg(12, 12);
Matrix RCFTSTLLinCrdTransf3D::kg(12, 12);
...
void
RCFTSTLLinCrdTransf3D::compTransfMatrixLocalGlobal(Matrix &Tlg)
{
...
CrdTransf *
RCFTSTLLinCrdTransf3D::getCopy3d(void)
{
...
const Matrix &
RCFTSTLLinCrdTransf3D::getGlobalMatrixFromLocal(const Matrix &ml)
{
