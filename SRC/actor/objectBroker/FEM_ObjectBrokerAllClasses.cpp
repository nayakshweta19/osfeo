...
/*neallee add timoshenko elements *//////////////////////////////////////
	case ELE_TAG_TimoshenkoBeam2d:
		return new TimoshenkoBeam2d();

	case ELE_TAG_Timoshenko2d01:
		return new Timoshenko2d01();
//////////////////////////////////////////////////////////////////////////
...
// add shell02 and shellnl ///////////////////////////////////////////////
	case ELE_TAG_Shell02:
		return new Shell02();
...
FEM_ObjectBrokerAllClasses::getNewSection(int classTag)
{
	...
	//	return new RASTMFiberSection2d();
	//case SEC_TAG_FASTMFiberSection2d:
	//	return new FASTMFiberSection2d();
	//case SEC_TAG_CSMMFiberSection2d:
	//	return new CSMMFiberSection2d();
	//case SEC_TAG_MCFTFiberSection2d:
	//	return new MCFTFiberSection2d();
	case SEC_TAG_TimoshenkoSection2d:
		return new TimoshenkoSection2d();
	case SEC_TAG_TimoshenkoSection3d:
		return new TimoshenkoSection3d();
	// ended by ln
...
FEM_ObjectBrokerAllClasses::getNewNDMaterial(int classTag)
{
  ...
  //  return new FAReinforcedConcretePlaneStress();
  //case ND_TAG_ReinforcedConcretePlaneStress:
  ...
  //case ND_TAG_RAReinforcedConcretePlateFiber:
	//  return new RAReinforcedConcretePlateFiber();
  //FAReinforcedConcretePlateFiber
  //case ND_TAG_FAReinforcedConcretePlateFiber:
	//  return new FAReinforcedConcretePlateFiber();
  
  case ND_TAG_NonlinearBS:
    return new NonlinearBS();
  //Ln added end
...
FEM_ObjectBrokerAllClasses::getNewFiber(int classTag)
{
	...
	case FIBER_TAG_Biaxial2d:
		return new BiaxialFiber2d();

	case FIBER_TAG_Biaxial3d:
		return new BiaxialFiber3d();
