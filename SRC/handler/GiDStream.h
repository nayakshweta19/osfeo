...
// $Source: /usr/local/cvs/OpenSees/SRC/handler/GiDStream.h,v $
...
class GiDStream : public OPS_Stream
{
 public:
  GiDStream(int indentSize=4);
  GiDStream(const char *fileName, openMode mode = OVERWRITE, int indentSize=4);
  ~GiDStream();
