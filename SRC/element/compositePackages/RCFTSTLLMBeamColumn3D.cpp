...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTSTLLMBeamColumn3D.cpp,v $
...
Matrix RCFTSTLLMBeamColumn3D::theMatrix(12,12);
Vector RCFTSTLLMBeamColumn3D::theVector(12);
double RCFTSTLLMBeamColumn3D::workArea[400];


//GaussQuadRule1d01 RCFTSTLLMBeamColumn3D::quadRule;
// constructor:
// invoked by a FEM_ObjectBroker, recvSelf() needs to be invoked on this object.
// CONSTRUCTOR FOR PARALLEL PROCESSING

RCFTSTLLMBeamColumn3D::RCFTSTLLMBeamColumn3D():
Element(0,ELE_TAG_RCFTSTLLMBeamColumn3D), connectedExternalNodes(2),
beamIntegr(0), numSections(0), sections(0), crdTransf(0),
rho(0.0), initialFlag(0), kv(NEBD,NEBD), Se(NEBD), Sg(NEGD), df_i(NEGD), f_i(NEGD), Sglobal(NEGD), kvcommit(NEBD,NEBD), Secommit(NEBD),
ks(0), Ki(0), XAxis(3), YAxis(3), ZAxis(3), sr(1,6), ss(1,1), T(5), V(5), V2(5), G(5,5), GT(5,5), G2(5,5), G2T(5,5), H(5,5), H12(5,5), H22(5,5), Md(5,5), Hinv(5,5),Kg(5,5), fint2(5), fnat2(5), Tfnat2(5), fk(5), fk_incr(5), ub(5), Tagg(0), itr(0)
{
  theNodes[0] = 0;
  theNodes[1] = 0;
...
RCFTSTLLMBeamColumn3D::RCFTSTLLMBeamColumn3D (int tag, int nodeI, int nodeJ,
                                      int numSec, RCFTSTLFiberSection3D **sec,
                                      BeamIntegration &bi,
                                      CrdTransf &coordTransf, double massDensPerUnitLength):
Element(tag,ELE_TAG_RCFTSTLLMBeamColumn3D), connectedExternalNodes(2),
beamIntegr(0), numSections(0), sections(0), crdTransf(0),
rho(massDensPerUnitLength),
initialFlag(0),
kv(NEBD,NEBD), Se(NEBD), Sg(NEGD), df_i(NEGD), f_i(NEGD),Sglobal(NEGD), kvcommit(NEBD,NEBD), Secommit(NEBD),
ks(0), Ki(0), XAxis(3), YAxis(3), ZAxis(3), sr(1,6), ss(1,1), T(5), V(5), V2(5), G(5,5), GT(5,5), G2(5,5), G2T(5,5), H(5,5), H12(5,5), H22(5,5), Md(5,5), Hinv(5,5),Kg(5,5), fint2(5), fnat2(5), Tfnat2(5), fk(5), fk_incr(5), ub(5), Tagg(tag), itr(0)
{
...
int
RCFTSTLLMBeamColumn3D::getNumExternalNodes(void) const
{
   return 2;
}
...
const ID &
RCFTSTLLMBeamColumn3D::getExternalNodes(void)
{
...
Node **
RCFTSTLLMBeamColumn3D::getNodePtrs(void)
{
   return theNodes;
}

int
RCFTSTLLMBeamColumn3D::getNumDOF(void)
{
   return NEGD;
}
...
void
RCFTSTLLMBeamColumn3D::setDomain(Domain *theDomain)
{
...
int RCFTSTLLMBeamColumn3D::revertToLastCommit()
{
   int err;
   int i = 0;
...
int RCFTSTLLMBeamColumn3D::revertToStart()
{
...
const Matrix &
RCFTSTLLMBeamColumn3D::getInitialStiff(void)
{
  if (Ki != 0)
    return *Ki;
...
const Vector &
RCFTSTLLMBeamColumn3D::getResistingForce(void){
  return Sglobal;
}

void RCFTSTLLMBeamColumn3D::calcResistingForce(void){
  crdTransf->update();
  Vector p0(12);
  p0.Zero();
...
void
RCFTSTLLMBeamColumn3D::initializeSectionHistoryVariables (void){
	for (int i = 0; i < numSections; i++){
		ksa[i]       = Matrix(4,4);
		fsa[i]       = Matrix(4,4);
		ks[i]        = Matrix(3,3);
...
int RCFTSTLLMBeamColumn3D::update()
{
#ifdef COMPOSITE_DEBUG
  ofstream geom;
...
const Matrix &
RCFTSTLLMBeamColumn3D::getMass(void)
{
  theMatrix.Zero();
...
void
RCFTSTLLMBeamColumn3D::zeroLoad(void)
{
	
}

int
RCFTSTLLMBeamColumn3D::addLoad(ElementalLoad *theLoad, double loadFactor)
{
  return 0;
}
...
int
RCFTSTLLMBeamColumn3D::addInertiaLoadToUnbalance(const Vector &accel)
{
  return 0;
}

const Vector &
RCFTSTLLMBeamColumn3D::getResistingForceIncInertia()
{
...
bool
RCFTSTLLMBeamColumn3D::isSubdomain(void)
{
    return false;
}
...
void
RCFTSTLLMBeamColumn3D::Print(OPS_Stream &s, int flag)
{
   if (flag == 1)
   {
...
OPS_Stream &operator<<(OPS_Stream &s, RCFTSTLLMBeamColumn3D &E)
{
    E.Print(s);
    return s;
}
...
int
RCFTSTLLMBeamColumn3D::displaySelf(Renderer &theViewer, int displayMode, float fact)
{
...
Response*
RCFTSTLLMBeamColumn3D::setResponse(char **argv, int argc, Information &eleInformation)
{
    // global force -
...
int
RCFTSTLLMBeamColumn3D::getResponse(int responseID, Information &eleInfo)
{
    switch (responseID) {
...
int
RCFTSTLLMBeamColumn3D::setParameter (const char **argv, int argc, Parameter &param)
{
	...
	if (parameterID < 0) {
		cerr << "RCFTSTLLMBeamColumn3D::setParameter() - could not set parameter. " << endl;
		return -1;
	}
	else {
...
int
RCFTSTLLMBeamColumn3D::updateParameter (int parameterID, Information &info)
{
	...
	if (ok < 0) {
		cerr << "RCFTSTLLMBeamColumn3D::updateParameter() - could not update parameter. " << endl;
		return ok;
	}
	else {
		return ok;
...
void
RCFTSTLLMBeamColumn3D::setSectionPointers(int numSec, RCFTSTLFiberSection3D **secPtrs)
{
  if (numSec > maxNumSections) {
    opserr << "Error: RCFTSTLLMBeamColumn3D::setSectionPointers -- max number of sections exceeded";
  }

  numSections = numSec;

  if (secPtrs == 0) {
    opserr << "Error: RCFTSTLLMBeamColumn3D::setSectionPointers -- invalid section pointer";
  }

  sections = new RCFTSTLFiberSection3D *[numSections];
  if (sections == 0) {
    opserr << "Error: RCFTSTLLMBeamColumn3D::setSectionPointers -- could not allocate section pointers";
  }

  for (int i = 0; i < numSections; i++) {

    if (secPtrs[i] == 0) {
      opserr << "Error: RCFTSTLLMBeamColumn3D::setSectionPointers -- null section pointer " << i << endln;
    }

    sections[i] = (RCFTSTLFiberSection3D*) secPtrs[i]->getCopy();

    if (sections[i] == 0) {
      opserr << "Error: RCFTSTLLMBeamColumn3D::setSectionPointers -- could not create copy of section " << i << endln;
    }
  ...
  if (ks == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate ks array";
  }

  if (fs == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate fs array";
  }

  if (ksa == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate ksa array";
  }
  
  if (fsa == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate fsa array";
  }
  
  if (nldhat == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nldhat array";
  }

  if (nldhatT == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nldhatT array";
  }
  
  if (dhat == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate dhat array";
  }

  if (nd1 == 0) {
    opserr << "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nd1 array";
  }
  
  if (nd1T == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nd1T array";
  }

  if (nd1Tf == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nd1Tf array";
  }

  if (nd1Tfnd1 == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nd1Tfnd1 array";
  }

  if (DSQ == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate DSQ array";
  }

  if (DQ == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate DQ array";
  }

  if (DSQa == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate DSQa array";
  }

  if (CDSQa == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate CDSQa array";
  }

  if (nd2T == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nd2T array";
  }

  if (nd2 == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nd2 array";
  }

  if (nd1Tfnd2 == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate nd1Tfnd2 array";
  }

  if (gd_delta == 0) {
    opserr <<  "RCFTSTLLMBeamColumn3D::setSectionPointers -- failed to allocate gd_delta array";
  }

}

Vector
RCFTSTLLMBeamColumn3D::getLocalIncrDeltaDisp(void)
{
...
const Vector& 
RCFTSTLLMBeamColumn3D::getBasicIncrDisp(void)
{
    return ub;									    
}	
...
Vector
RCFTSTLLMBeamColumn3D::getBasicIncrDeltaDisp(void)
{
   const Vector &disp1 = theNodes[0]->getIncrDeltaDisp();
   const Vector &disp2 = theNodes[1]->getIncrDeltaDisp();
...
Vector
RCFTSTLLMBeamColumn3D::getd_hat(int sec, const Vector &v)
{
   double L = crdTransf->getInitialLength();
   double oneOverL  = 1.0/L;
...
Matrix
RCFTSTLLMBeamColumn3D::getKg(int sec)
{
   double L = crdTransf->getInitialLength();
   double oneOverL  = 1.0/L;
...
Matrix
RCFTSTLLMBeamColumn3D::getNld_hat(int sec, const Vector &v){
   int i,j;
...
Matrix
RCFTSTLLMBeamColumn3D::getNd2(int sec){
   double L = crdTransf->getInitialLength();
   double oneOverL  = 1.0/L;
...
Matrix
RCFTSTLLMBeamColumn3D::getNd1(int sec, const Vector &v){
   double L = crdTransf->getInitialLength();  
   double oneOverL  = 1.0/L;
...
void RCFTSTLLMBeamColumn3D::calcDeformedLength(void){
...
double RCFTSTLLMBeamColumn3D::getDeformedLength(void){
   return deflength; 
}

int
RCFTSTLLMBeamColumn3D::sendSelf(int commitTag, Channel &theChannel){  
   return 0;
}
    
int
RCFTSTLLMBeamColumn3D::recvSelf(int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker){
   return 0;
}
