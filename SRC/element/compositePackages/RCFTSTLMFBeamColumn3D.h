...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTSTLMFBeamColumn3D.h,v $


// File: ~/model/element/RCFTSTLMFBeamColumn3D.h

#ifndef RCFTSTLMFBeamColumn3D_h
#define RCFTSTLMFBeamColumn3D_h
...
class RCFTSTLMFBeamColumn3D: public Element
{
  public:
    RCFTSTLMFBeamColumn3D ();
    RCFTSTLMFBeamColumn3D (int tag, int nodeI, int nodeJ,
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, RCFTSTLMFBeamColumn3D &E);
