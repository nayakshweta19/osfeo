...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTGMBeamColumn3D.h,v $


// File: ~/model/element/RCFTGMBeamColumn3D.h

#ifndef RCFTGMBeamColumn3D_h
#define RCFTGMBeamColumn3D_h
...
class RCFTGMBeamColumn3D: public Element
{
  public:
    RCFTGMBeamColumn3D ();
    RCFTGMBeamColumn3D (int tag, int nodeI, int nodeJ,
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, RCFTGMBeamColumn3D &E);
