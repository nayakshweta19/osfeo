...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTSTLLMBeamColumn3D.h,v $


// File: ~/model/element/RCFTSTLMBeamColumn3D.h

#ifndef RCFTSTLLMBeamColumn3D_h
#define RCFTSTLLMBeamColumn3D_h
...
class RCFTSTLLMBeamColumn3D: public Element
{
  public:
    RCFTSTLLMBeamColumn3D ();
    RCFTSTLLMBeamColumn3D (int tag, int nodeI, int nodeJ,
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, RCFTSTLLMBeamColumn3D &E);
