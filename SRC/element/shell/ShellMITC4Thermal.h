...
// Modified by J.Jiang(UoE),2012
// Modified by Liming(UoE), 2013
...
#include <R3vectors.h>
#include <ElementalLoad.h>   //by UoE
...
class ShellMITC4Thermal : public Element {
 ...
 public:
  ...
  private : 
	...
	// added for temperature dependent property, by UoE
	double *dataMix;
	int counterTemperature; 
	double residThermal[24];
} ; 
