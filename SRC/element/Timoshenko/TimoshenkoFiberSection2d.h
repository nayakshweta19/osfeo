// $Source: /usr/local/cvs/OpenSees/SRC/element/Timoshenko/TimoshenkoFiberSection2d.h,v $
// $Revision: 1.1 $
...
#ifndef TimoshenkoFiberSection2d_h
#define TimoshenkoFiberSection2d_h
...
class TimoshenkoFiberSection2d : public SectionForceDeformation
{
  public:
    TimoshenkoFiberSection2d(); 
    TimoshenkoFiberSection2d(int tag, 
		      int numFibers, 
		      Fiber **fibers, 
		      int numHFibers, 
		      Fiber **Hfibers, 
