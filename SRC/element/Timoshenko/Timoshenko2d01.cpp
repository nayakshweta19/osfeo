...
Timoshenko2d01::update(void)
{
  ...
  for (int i = 0; i < numSections; i++) {
	...
	e(j) = oneOverL*(-v(1)+v(4))-xi*v(2)+(xi-1.0)*v(5); break;
	  default:
	break;
      }
	}
...
Timoshenko2d01::getTangentStiff(void)
{
  ...
  for (int i = 0; i < numSections; i++) {
    ...
    for (j = 0; j < order; j++) {
      switch(code(j)) {
        case SECTION_RESPONSE_P:
		  ka(j,0) += (ks(0,j) * -1 + ks(1,j) * 0 + ks(2,j) *  0   )* wti;
		  ka(j,1) += (ks(0,j) *  0 + ks(1,j) * 0 + ks(2,j) * -1   )* wti;
		  ka(j,2) += (ks(0,j) *  0 + ks(1,j) * 1 + ks(2,j) *(xi-1))* wti;
		  ka(j,3) += (ks(0,j) *  1 + ks(1,j) * 0 + ks(2,j) *  0   )* wti;
		  ka(j,4) += (ks(0,j) *  0 + ks(1,j) * 0 + ks(2,j) *  1   )* wti;
		  ka(j,5) += (ks(0,j) *  0 + ks(1,j) *-1 + ks(2,j) * -xi  )* wti;
	      break;
    ...
    for (j = 0; j < order; j++) {
      switch (code(j)) {
        case SECTION_RESPONSE_P:
		  kb(j,0)   += (ka(0,0) * -1 +ka(1,0) * 0 + ka(2,0) *  0   );
		  kb(j,1)   += (ka(0,0) *  0 +ka(1,0) * 0 + ka(2,0) * -1   );
		  kb(j,2)   += (ka(0,0) *  0 +ka(1,0) * 1 + ka(2,0) *(xi-1));
		  kb(j,3)   += (ka(0,0) *  1 +ka(1,0) * 0 + ka(2,0) *  0   );
		  kb(j,4)   += (ka(0,0) *  0 +ka(1,0) * 0 + ka(2,0) *  1   );
		  kb(j,5)   += (ka(0,0) *  0 +ka(1,0) *-1 + ka(2,0) * -xi  );
		  kb(j+3,0) += (ka(0,3) * -1 +ka(1,3) * 0 + ka(2,3) *  0   );
		  kb(j+3,1) += (ka(0,3) *  0 +ka(1,3) * 0 + ka(2,3) * -1   );
		  kb(j+3,2) += (ka(0,3) *  0 +ka(1,3) * 1 + ka(2,3) *(xi-1));
		  kb(j+3,3) += (ka(0,3) *  1 +ka(1,3) * 0 + ka(2,3) *  0   );
		  kb(j+3,4) += (ka(0,3) *  0 +ka(1,3) * 0 + ka(2,3) *  1   );
		  kb(j+3,5) += (ka(0,3) *  0 +ka(1,3) *-1 + ka(2,3) * -xi  );
	      break;
		case SECTION_RESPONSE_MZ:
		  kb(j,0)   += (ka(0,1) * -1 +ka(1,1) * 0 + ka(2,1) *  0   );
		  kb(j,1)   += (ka(0,1) *  0 +ka(1,1) * 0 + ka(2,1) * -1   );
		  kb(j,2)   += (ka(0,1) *  0 +ka(1,1) * 1 + ka(2,1) *(xi-1));
		  kb(j,3)   += (ka(0,1) *  1 +ka(1,1) * 0 + ka(2,1) *  0   );
		  kb(j,4)   += (ka(0,1) *  0 +ka(1,1) * 0 + ka(2,1) *  1   );
		  kb(j,5)   += (ka(0,1) *  0 +ka(1,1) *-1 + ka(2,1) * -xi  );
		  kb(j+3,0) += (ka(0,4) * -1 +ka(1,4) * 0 + ka(2,4) *  0   );
		  kb(j+3,1) += (ka(0,4) *  0 +ka(1,4) * 0 + ka(2,4) * -1   );
		  kb(j+3,2) += (ka(0,4) *  0 +ka(1,4) * 1 + ka(2,4) *(xi-1));
		  kb(j+3,3) += (ka(0,4) *  1 +ka(1,4) * 0 + ka(2,4) *  0   );
		  kb(j+3,4) += (ka(0,4) *  0 +ka(1,4) * 0 + ka(2,4) *  1   );
		  kb(j+3,5) += (ka(0,4) *  0 +ka(1,4) *-1 + ka(2,4) * -xi  );
	      break;
		case SECTION_RESPONSE_VY:
		  kb(j,0)   += (ka(0,2) * -1 +ka(1,2) * 0 + ka(2,2) *  0   );
		  kb(j,1)   += (ka(0,2) *  0 +ka(1,2) * 0 + ka(2,2) * -1   );
		  kb(j,2)   += (ka(0,2) *  0 +ka(1,2) * 1 + ka(2,2) *(xi-1));
		  kb(j,3)   += (ka(0,2) *  1 +ka(1,2) * 0 + ka(2,2) *  0   );
		  kb(j,4)   += (ka(0,2) *  0 +ka(1,2) * 0 + ka(2,2) *  1   );
		  kb(j,5)   += (ka(0,2) *  0 +ka(1,2) *-1 + ka(2,2) * -xi  );
		  kb(j+3,0) += (ka(0,5) * -1 +ka(1,5) * 0 + ka(2,5) *  0   );
		  kb(j+3,1) += (ka(0,5) *  0 +ka(1,5) * 0 + ka(2,5) * -1   );
		  kb(j+3,2) += (ka(0,5) *  0 +ka(1,5) * 1 + ka(2,5) *(xi-1));
		  kb(j+3,3) += (ka(0,5) *  1 +ka(1,5) * 0 + ka(2,5) *  0   );
		  kb(j+3,4) += (ka(0,5) *  0 +ka(1,5) * 0 + ka(2,5) *  1   );
		  kb(j+3,5) += (ka(0,5) *  0 +ka(1,5) *-1 + ka(2,5) * -xi  );
	      break;
		default: 
		  break;
      }
    ...
    s1 = s1*wts[i];   s2 = s2*wts[i];   s3 = s3*wts[i];
    for (j = 0; j < order; j++) {
      switch(code(j)) {
      case SECTION_RESPONSE_P:
	q(j)   += -1 * s1;
