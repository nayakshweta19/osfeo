// $Source: /usr/local/cvs/OpenSees/SRC/element/Timoshenko/MCFTFiberSection2d.h,v $
// $Revision: 1.1 $
...
#ifndef MCFTFiberSection2d_h
#define MCFTFiberSection2d_h
...
class MCFTFiberSection2d : public SectionForceDeformation
{
  public:
    MCFTFiberSection2d(); 
    MCFTFiberSection2d(int tag, 
		      int numFibers, 
		      Fiber **fibers, 
		      int numHFibers, 
		      Fiber **Hfibers, 
	...
	const char *getClassType(void) const {return "MCFTFiberSection2d";};
