// $Source: /usr/local/cvs/OpenSees/SRC/element/Timoshenko/CSMMFiberSection2d.h,v $
// $Revision: 1.1 $
...
#ifndef CSMMFiberSection2d_h
#define CSMMFiberSection2d_h
...
class CSMMFiberSection2d : public SectionForceDeformation
{
  public:
    CSMMFiberSection2d(); 
    CSMMFiberSection2d(int tag, 
		      int numFibers, 
		      Fiber **fibers, 
		      int NStrip1, 
		      double tavg1, 
	...
	const char *getClassType(void) const {return "CSMMFiberSection2d";};
