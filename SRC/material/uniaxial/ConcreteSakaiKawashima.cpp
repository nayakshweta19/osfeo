...
extern "C" int COMPR14 (double *EPS1, double *Sig1, double *YMtan, int *Jcon, double *EPS0,
...
extern "C" int TENSI14 (double *EPS1, double *Sig1, double *YMtan, int *Jcon, double *EPS0,
