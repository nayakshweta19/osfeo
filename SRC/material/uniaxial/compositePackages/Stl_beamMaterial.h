...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/material/uniaxial/Stl_beamMaterial.h,v $
...
#ifndef Stl_beamMaterial_h
#define Stl_beamMaterial_h

#include <UniaxialMaterial.h>

class Stl_beamMaterial : public UniaxialMaterial
{
 public:
  Stl_beamMaterial(int tag, double Fy, double Fu, double es, double BF, double TF, double HW, double TW, double Eplo);
  Stl_beamMaterial();    
  ~Stl_beamMaterial();
