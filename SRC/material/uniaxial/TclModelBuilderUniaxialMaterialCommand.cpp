...
#include <Concrete09.h>         //Neallee@tju.edu.cn
#include <Concrete10.h>         //Neallee@tju.edu.cn
#include <MCFTConcrete01.h>     //Neallee@tju.edu.cn
#include <MCFTConcrete02.h>     //Neallee@tju.edu.cn
#include <MCFTConcrete03.h>     //Neallee@tju.edu.cn
#include <MCFTSteel01.h>        //Neallee@tju.edu.cn
#include <MCFTSteel02.h>        //Neallee@tju.edu.cn
#include <MCFTSteel03.h>        //Neallee@tju.edu.cn
...
extern void *OPS_NewConcreteL02Material(void);    //
...
TclModelBuilderUniaxialMaterialCommand (ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv, Domain *theDomain)
{
  ...
  // Make sure there is a minimum number of arguments
    ...
    } else if ((strcmp(argv[1],"Brace") == 0) || (strcmp(argv[1],"brace") == 0)) {
      void *theMat = OPS_Brace();
      if (theMat != 0) 
	theMaterial = (UniaxialMaterial *)theMat;
      else 
	return TCL_ERROR;
    ...
    } else if (strcmp(argv[1],"SecantConcrete") == 0) {
      void *theMat = OPS_NewSecantConcreteMaterial();
	  if (theMat != 0) 
	theMaterial = (UniaxialMaterial *)theMat;
	  else 
	return TCL_ERROR;
	...
	theMaterial = new Elastic2Material(tag, E, eta);       
	  ...
	  void *theMat = OPS_NewReinforcingSteel();
	  if (theMat != 0)
		  theMaterial = (UniaxialMaterial *)theMat;
	  else
		  return TCL_ERROR;
    ...
    *************************************************************** */
	...
	else if ((strcmp(argv[1],"concrete10") == 0) || (strcmp(argv[1],"Concrete10") == 0)) {
	  void *theMat = OPS_NewConcrete10Material();
	  if (theMat != 0) 
	theMaterial = (UniaxialMaterial *)theMat;
	  else 
	return TCL_ERROR;
	...
	else if ((strcmp(argv[1],"SteelZ02Material") == 0) || (strcmp(argv[1],"SteelZ02") == 0)) {
	  void *theMat = OPS_NewSteelZ02Material();
	  if (theMat != 0) 
	theMaterial = (UniaxialMaterial *)theMat;
	  else 
	return TCL_ERROR;
	...
	else if ((strcmp(argv[1],"ConcreteZ02Material") == 0) || (strcmp(argv[1],"ConcreteZ02") == 0)) {
	  void *theMat = OPS_NewConcreteZ02Material();
	  if (theMat != 0) 
	theMaterial = (UniaxialMaterial *)theMat;
	  else 
	return TCL_ERROR;
    ...
    else if ((strcmp(argv[1],"ConcreteL02Material") == 0) || (strcmp(argv[1],"ConcreteL02") == 0)) {
  	  void *theMat = OPS_NewConcreteL02Material();
      if (theMat != 0) 
    theMaterial = (UniaxialMaterial *)theMat;
      else 
    return TCL_ERROR;
	...
	else if (strcmp(argv[1],"MCFTConcrete01") == 0) {
  	  void *theMat = OPS_NewMCFTConcrete01Material();
      if (theMat != 0) 
    theMaterial = (UniaxialMaterial *)theMat;
      else 
    return TCL_ERROR;
	...
	else if (strcmp(argv[1],"MCFTConcrete02") == 0) {
  	  void *theMat = OPS_NewMCFTConcrete02Material();
      if (theMat != 0) 
    theMaterial = (UniaxialMaterial *)theMat;
      else 
    return TCL_ERROR;
	...
	else if (strcmp(argv[1],"MCFTConcrete03") == 0) {
  	  void *theMat = OPS_NewMCFTConcrete03Material();
      if (theMat != 0) 
    theMaterial = (UniaxialMaterial *)theMat;
      else 
    return TCL_ERROR;
	...
	else if (strcmp(argv[1],"MCFTSteel01") == 0) {
  	  void *theMat = OPS_NewMCFTSteel01Material();
      if (theMat != 0) 
    theMaterial = (UniaxialMaterial *)theMat;
      else 
    return TCL_ERROR;
	...
	else if (strcmp(argv[1],"MCFTSteel02") == 0) {
  	  void *theMat = OPS_NewMCFTSteel02Material();
      if (theMat != 0) 
    theMaterial = (UniaxialMaterial *)theMat;
      else 
    return TCL_ERROR;
	...
	else if (strcmp(argv[1],"MCFTSteel03") == 0) {
  	  void *theMat = OPS_NewMCFTSteel03Material();
      if (theMat != 0) 
    theMaterial = (UniaxialMaterial *)theMat;
      else 
    return TCL_ERROR;
