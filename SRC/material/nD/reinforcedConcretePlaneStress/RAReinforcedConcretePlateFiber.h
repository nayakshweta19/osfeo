...
#ifndef RAReinforcedConcretePlateFiber_h
#define RAReinforcedConcretePlateFiber_h

// File: RAReinforcedConcretePlateFiber.h
//
// Written: JZhong
// Created: 2003.10
//
...
// RAReinforcedConcretePlateFiber material.
// Hsu's Model 2002
...
class RAReinforcedConcretePlateFiber : public NDMaterial
{
  public:
    RAReinforcedConcretePlateFiber (int      tag, 
				  double   RHO,
				  UniaxialMaterial *s1,
				  UniaxialMaterial *s2,
				  UniaxialMaterial *c1,
  ...
  private:
    ...
    double   Tstress[5];  // Trial stresses
    double   lastStress[5];  // Last committed stresses, added for x, k
