...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/Concrete10.h,v $
                                                                      
// Written: Li Ning (neallee@tju.edu.cn)
// Created: 03/07
//
// Description: This file contains the class definition for 
// Concrete10. Concrete10 is based on an f2c of the FEDEAS material
// Concr2.f which is:
/*-----------------------------------------------------------------------
...
class Concrete10 : public UniaxialMaterial
{
  public:
    Concrete10(int tag, double _fc, double _epsc0, double _fcu,
    ...
    const char *getClassType(void) const {return "Concrete10";};    
