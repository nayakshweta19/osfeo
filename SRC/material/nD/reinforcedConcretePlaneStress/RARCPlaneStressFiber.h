#ifndef RARCPlaneStressFiber_h
#define RARCPlaneStressFiber_h
...
class RARCPlaneStressFiber : public NDMaterial
{
  public:
    RARCPlaneStressFiber (int      tag, 
				  double   RHO,
				  UniaxialMaterial *s1,
				  UniaxialMaterial *s2,
				  UniaxialMaterial *c1,
