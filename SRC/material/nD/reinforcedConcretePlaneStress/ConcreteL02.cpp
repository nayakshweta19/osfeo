...
int ConcreteL02::setTrialStrain (double x, double k, double Dfactor, double BETA, double EPSLONTP, double strain, double strainRate)
{
...
int ConcreteL02::setTrialStrain (double strain, double strainRate)
{
   /* Make all prestressing stress and strain negative*/
   if (sigmaCI > 0.0)
		sigmaCI = -sigmaCI;
...
int ConcreteL02::setTrial (double x, double k, double Dfactor, double BETA, double EPSLONTP, double strain, double &stress, double &tangent, double strainRate)
{
...
int ConcreteL02::setTrial (double strain, double &stress, double &tangent, double strainRate)
{
   /* Make all prestressing stress and strain negative*/
	if (sigmaCI > 0.0)
		sigmaCI = -sigmaCI;
...
double ConcreteL02::getStrain ()
{
   return Tstrain;
}

double ConcreteL02::getStress ()
{
   return Tstress;
}

double ConcreteL02::getTangent ()
{
   return Ttangent;
}

double ConcreteL02::getSecant ()
{
	double TSecant;
	if ( Tstrain == 0.0 )
	{
...
double ConcreteL02::getZeta ()
{
	return zeta;
}

int ConcreteL02::commitState ()
{
   // History variables
...
int ConcreteL02::revertToLastCommit ()
{
...
void ConcreteL02::determineTrialState (double dStrain)
{
	double Ec0 = 1.4*fpc/epsc0;
	if ( TloadingState == 0 )
	{
...
void ConcreteL02::getApproachFiveToComStrain( )
{
    approachFiveToComStrain = 0.0; 
	...
	{
		//opserr << " ConcreteL02::getApproachFiveToComStrain -- can not get approachFiveToComStrain! \n";
...
void ConcreteL02::getApproachSixToComStrain( )
{
    approachSixToComStrain = 0.0;
...
UniaxialMaterial* ConcreteL02::getCopy ()
{
...
int ConcreteL02::sendSelf (int commitTag, Channel& theChannel)
{
   int res = 0;
...
int ConcreteL02::recvSelf (int commitTag, Channel& theChannel,
...
Response* 
ConcreteL02::setResponse(const char **argv, int argc,
...
void ConcreteL02::Print (OPS_Stream& s, int flag)
{
