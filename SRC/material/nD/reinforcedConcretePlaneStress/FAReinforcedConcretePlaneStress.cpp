  ...
  if ( status == 0 ) // does not get converged after iteration
    {
      ...
      // if ( minError > 0.05 )
	  opserr << "FAReinforcedConcretePlaneStress::determineTrialStress: Warning, failure to get converged principal stress. error=" << error / PI * 180 << endln;
    } 
