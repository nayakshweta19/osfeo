...
NDMaterial* 
MCFTRCPlaneStress02::getCopy(void)
{
...
NDMaterial* 
MCFTRCPlaneStress02::getCopy(const char *type)
{
...
int
MCFTRCPlaneStress02::determineTangent(Vector strain)
{
  Vector Tstrain;
...
double 
MCFTRCPlaneStress02::determinefS(double strain, double fy, double E, double Esh)
{
  double epsy  = fy/E;
  double epssh = 0.008;
  double epsu  = 0.15;
...
double 
MCFTRCPlaneStress02::calcBetaD(double epsC1, double epsC2)
{
    double Cd;
	double Cs = 0.55;
...
int
MCFTRCPlaneStress02::checkAtCrack()
{
...
Vector
MCFTRCPlaneStress02::determineMCFTStress(double epsC1, double epsC2)
{
