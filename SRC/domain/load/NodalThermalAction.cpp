...
NodalThermalAction::NodalThermalAction(int tag, int theNodeTag,
  ...
  :NodalLoad(tag, theNodeTag,LOAD_TAG_NodalThermalAction),data(18),
...
NodalThermalAction::NodalThermalAction(int tag, int theNodeTag,
					 ...
					 double locY5,double locY6,double locY7,double locY8,double locY9,
					 TimeSeries* theSeries
					 )
  :NodalLoad(tag, theNodeTag,  LOAD_TAG_NodalThermalAction),theSeries(theSeries),
  data(18),ThermalActionType(1)  
{
	...
	Loc[0]=locY1;Loc[1]=locY2;Loc[2]=locY3;Loc[3]=locY4;Loc[4]=locY5;Loc[5]=locY6;
	Loc[6]=locY7;Loc[7]=locY8;Loc[8]=locY9;
...
{
  //s << "NodalThermalAction: " << myNode<<endln;
}
