...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/analysis/integrator/ArcLengthw.h,v $
...
class ArcLengthw : public StaticIntegrator
{
  public:
    ArcLengthw(double ifactor, int jd);
  ...
  private:
    ...
    int iflag; // flag for start of analysis
};
