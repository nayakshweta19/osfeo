...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/coordTransformation/RCFTSTLCrdTransf3D.h,v $
...
#ifndef RCFTSTLCrdTransf3D_h
#define RCFTSTLCrdTransf3D_h

#include <CrdTransf3d.h>
#include <Vector.h>
#include <Matrix.h>

class RCFTSTLCrdTransf3D: public CrdTransf3d
{
  public:
    RCFTSTLCrdTransf3D (int tag, const Vector &vecInLocXZPlane);
