...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/coordTransformation/RCFTSTLLinCrdTransf3D.h,v $
                                                                        
                                                                        
// File: ~/crdTransf/RCFTSTLLinCrdTransf3d.h
//
//
...
#ifndef RCFTSTLLinCrdTransf3D_h
#define RCFTSTLLinCrdTransf3D_h

#include <CrdTransf.h>
#include <Vector.h>
#include <Matrix.h>

class RCFTSTLLinCrdTransf3D: public CrdTransf
{
  public:
    RCFTSTLLinCrdTransf3D (int tag, const Vector &vecInLocXZPlane);
    
    RCFTSTLLinCrdTransf3D();
    ~RCFTSTLLinCrdTransf3D();
