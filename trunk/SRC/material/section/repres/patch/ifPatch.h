...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/material/section/repres/patch/ifPatch.h,v $
...
class ifPatch: public Patch
{
  public:

    ifPatch();
    ifPatch(int materialID, double D, double B, double TF, double TW, double FILLET, int SFL_D, int SFL_B, 
	   int SWL_D, int SWL_B);
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, ifPatch &if_Patch);    
