...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/material/section/repres/patch/tubePatch.h,v $
                                                                        
                                                                        
// File: RCFT_stl_Patch.h
...
class tubePatch: public Patch
{
  public:

    tubePatch();
    tubePatch(int materialID, double D, double B, double T, int SFL_D, int SFL_B, int SWL_D, int SWL_B);
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, tubePatch &tube_Patch);    
