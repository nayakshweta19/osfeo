...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/material/section/repres/cell/iCell.h,v $
...
class iCell: public Cell
{
  public:
    ...
    iCell();
    iCell(const int &type, const Vector &centroid, const double &area );
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, const iCell &i_Cell);    
