...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/material/section/repres/cell/ifCell.h,v $
...
class ifCell: public Cell
{
  public:
    ...
    ifCell();
    ifCell(const int &type, const Vector &centroid, const double &area );
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, const ifCell &if_Cell);    
