...
extern  void *OPS_NewCSMMRCPlaneStressMaterial(void);
extern  void *OPS_NewMCFTRCPlaneStressMaterial(void);
extern  void *OPS_NewMCFTRCPlaneStress02Material(void);
extern  void *OPS_NewDSFMRCPlaneStressMaterial(void);
extern  void *OPS_NewRAReinforcedConcretePlateFiberMaterial(void);
extern  void *OPS_NewFAReinforcedConcretePlateFiberMaterial(void);
...
TCL_Char **argv, TclModelBuilder *theTclBuilder)
{
	...
	else if ((strcmp(argv[1], "CSMMRCPlaneStress") == 0)) {

		void *theMat = OPS_NewCSMMRCPlaneStressMaterial();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "MCFTRCPlaneStress") == 0)) {

		void *theMat = OPS_NewMCFTRCPlaneStressMaterial();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "MCFTRCPlaneStress02") == 0)) {

		void *theMat = OPS_NewMCFTRCPlaneStress02Material();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "DSFMRCPlaneStress") == 0)) {

		void *theMat = OPS_NewDSFMRCPlaneStressMaterial();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "RAReinforcedConcretePlateFiber") == 0)) {

		void *theMat = OPS_NewRAReinforcedConcretePlateFiberMaterial();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "FAReinforcedConcretePlateFiber") == 0)) {

		void *theMat = OPS_NewFAReinforcedConcretePlateFiberMaterial();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "CSMMRCPlateFiber") == 0)) {

		void *theMat = OPS_NewCSMMRCPlateFiberMaterial();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "Mcft07") == 0)) {

		void *theMat = OPS_NewConcreteMcftNonlinear7Material();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "BoucWen3D") == 0)) {

		void *theMat = OPS_NewBoucWen3DMaterial();
		if (theMat != 0)
			theMaterial = (NDMaterial *)theMat;
		else
			return TCL_ERROR;
	...
	*/
	...
	//end Yuli Huang & Xinzheng Lu PlaneStressUserMaterial
		...
		if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK) {
			opserr << "WARNING invalid nDMaterial BeamFiber2d tag" << endln;
			return TCL_ERROR;
		}

		if (Tcl_GetInt(interp, argv[3], &matTag) != TCL_OK) {
			opserr << "WARNING invalid matTag" << endln;
			opserr << "BeamFiber2d: " << matTag << endln;
			return TCL_ERROR;
		}
