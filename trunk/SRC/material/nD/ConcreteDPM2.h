...
// $Source: /usr/local/cvs/OpenSees/SRC/material/nD/ConcreteDPM2.h,v $
...
class ConcreteDPM2 : public NDMaterial
{
  public:
    ...
    virtual void giveRealStressVector_1d(Vector &answer, const Vector &strainVector);
    virtual void giveRealStressVector(Vector &answer, const Vector &reducedStrain);
    ...
    */
    ...
    double ConcreteDPM2::computeMeanSize();

    void ConcreteDPM2::computePrincipalValues(Matrix &answer);
  ...
  protected:
    ...
    */
    ...
    double yieldHardPrimePeak;/// Parameter of the hardening law of the plasticity model.
    ...
    int softeningType;/// Type of softening function used.

    double kappaP;/// Hardening variable of plasticity model.
    double tempKappaP;

    double kappaD;/// Hardening variable of damage model.
    double tempKappaD;

    double damage;/// Damage variable of damage model.
    double tempDamage;

    double efCompression;    /// Control parameter for the exponential softening law.

    double wf;    /// Control parameter for the linear/bilinear softening law in tension.
    double wfOne;    /// Control parameter for the bilinear softening law in tension
    double ftOne;    /// Control parameter for the bilinear softening law.

    double yieldTol;    /// yield tolerance for the plasticity model.
    double yieldTolDamage;    /// yield tolerance for the damage model.

    int newtonIter;    /// Maximum number of iterations for stress return.
