...
#include <FAPrestressConcretePlaneStress.h>
...
//Vector FAPrestressConcretePlaneStress :: strain_vec(3);
//Vector FAPrestressConcretePlaneStress :: stress_vec(3);
//Matrix FAPrestressConcretePlaneStress :: tangent_matrix(3,3);
#define ND_TAG_FAReinforceConcretePlaneStress 30215
...
OPS_NewFAPrestressedConcretePlaneStressMaterial()
{
	...
	theMaterial = new FAPrestressConcretePlaneStress (tag, 
		rho,
...
FAPrestressConcretePlaneStress ::
FAPrestressConcretePlaneStress ( int      tag, 
	                           double   RHO,
							   UniaxialMaterial *t1,
							   UniaxialMaterial *s1,
							   UniaxialMaterial *c1,
							   ...
							   double   E,
							   double   EPSC0) :
	NDMaterial(tag, ND_TAG_FAReinforceConcretePlaneStress), 
	...
	fpc(FPC), fy1(FY1), fy2(FY2), E0(E), epsc0(EPSC0), strain_vec(3), stress_vec(3),tangent_matrix(3,3)
{
	...
	if ( theMaterial == 0 ) {
		opserr << " FAPrestressConcretePlaneStress::FAPrestressConcretePlaneStress - failed allocate material array\n";
		exit(-1);
	}
	...
	// Check allocation    
	if ( theMaterial[0] == 0 ) {
		opserr << " FAPrestressConcretePlaneStress::FAPrestressConcretePlaneStress - failed to get a copy for steel1\n";
		exit(-1);
	}
	...
	// Check allocatio    
	if ( theMaterial[1] == 0 ) {
		opserr << " FAPrestressConcretePlaneStress::FAPrestressConcretePlaneStress - failed to get a copy for steel2\n";
		exit(-1);
	}
	...
	// Check allocation    
	if ( theMaterial[2] == 0 ) {
		opserr << " FAPrestressConcretePlaneStress::FAPrestressConcretePlaneStress - failed to get a copy for concrete1\n";
		exit(-1);
	}
	...
	// Check allocation    
	if ( theMaterial[3] == 0 ) {
		opserr << " FAPrestressConcretePlaneStress::FAPrestressConcretePlaneStress - failed to get a copy for concrete2\n";
		exit(-1);
	}
...
FAPrestressConcretePlaneStress::FAPrestressConcretePlaneStress()
:NDMaterial(0, ND_TAG_FAReinforceConcretePlaneStress), strain_vec(3),
...
double FAPrestressConcretePlaneStress::getRho(void)
{
	return rho;
}


int FAPrestressConcretePlaneStress::setTrialStrain(const Vector &v)
{
...
///*
int FAPrestressConcretePlaneStress::setTrialStrain(const Vector &v, const Vector &r)
{
   	// Set values for strain_vec
	strain_vec(0) = v(0);
	strain_vec(1) = v(1);
...
int FAPrestressConcretePlaneStress::setTrialStrainIncr(const Vector &v)
{
	// Set values for strain_vec
	strain_vec(0) = v(0);
	strain_vec(1) = v(1);
...
int FAPrestressConcretePlaneStress::setTrialStrainIncr(const Vector &v, const Vector &r)
{
	// Set values for strain_vec
	strain_vec(0) = v(0);
	strain_vec(1) = v(1);
...
const Matrix& FAPrestressConcretePlaneStress::getTangent(void)
{
	return tangent_matrix;
}

const Vector& FAPrestressConcretePlaneStress::getStress(void)
{
...
const Vector& FAPrestressConcretePlaneStress :: getStrain()
{
	return strain_vec;
}
    

const Vector& FAPrestressConcretePlaneStress::getCommittedStress(void)
{
    return stress_vec;
}


const Vector& FAPrestressConcretePlaneStress::getCommittedStrain(void)
{
    return strain_vec;
}
    

int FAPrestressConcretePlaneStress::commitState(void)
{
    for (int i=0; i<4; i++)
	{
...
int FAPrestressConcretePlaneStress::revertToLastCommit(void)
{
...
int FAPrestressConcretePlaneStress::revertToStart(void)
{
    for (int i=0; i<4; i++)
	{
...
NDMaterial* FAPrestressConcretePlaneStress::getCopy(void)
{
	/*
	FAPrestressConcretePlaneStress *clone;
	clone = new FAPrestressConcretePlaneStress();
	*clone = *this;
	return clone;
	//*/

	FAPrestressConcretePlaneStress* theCopy =
		new FAPrestressConcretePlaneStress( this->getTag(), 
...
NDMaterial* FAPrestressConcretePlaneStress::getCopy(const char *type)
{
    /*
	FAPrestressConcretePlaneStress *clone;
	clone = new FAPrestressConcretePlaneStress();
	*clone = *this;
	return clone;
	//*/
	FAPrestressConcretePlaneStress* theModel =
		new FAPrestressConcretePlaneStress( this->getTag(), 
           rho, theMaterial[0], theMaterial[1], theMaterial[2], theMaterial[3], angle1, angle2, rou1, rou2, pstrain, fpc, fy1, fy2, E0, epsc0 );
...
void FAPrestressConcretePlaneStress::Print(OPS_Stream &s, int flag )
{
...
int FAPrestressConcretePlaneStress::sendSelf(int commitTag, Channel &theChannel)
{
	int res = 0;
    ...
    if (res < 0) {
      opserr << "WARNING FAPrestressConcretePlaneStress::sendSelf() - " << this->getTag() << " failed to send Vector\n";
      return res;
	}	      
    ...
    if (res < 0) {
       opserr << "WARNING FAPrestressConcretePlaneStress::sendSelf() - " << this->getTag() << " failed to send ID\n";
       return res;
	}
   ...
   for (int i = 0; i < 4; i++) {
    ...
    if (res < 0) {
      opserr << "FAPrestressConcretePlaneStress::sendSelf() - " << this->getTag() << " failed to send its Material\n";
      return res;
    }
   }	
...
int FAPrestressConcretePlaneStress::recvSelf(int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
  int res = 0;
  ...
  if (res < 0) {
    opserr << "WARNING FAPrestressConcretePlaneStress::recvSelf() - failed to receive Vector\n";
    return res;
  }
  ...
  if (res < 0) {
    opserr << "WARNING FAPrestressConcretePlaneStress::recvSelf() - " << this->getTag() << " failed to receive ID\n";
    return res;
  }
  ...
  if (theMaterial == 0) {
    ...
    theMaterial = new UniaxialMaterial *[4];
    if (theMaterial == 0) {
      opserr << "FAPrestressConcretePlaneStress::recvSelf() - Could not allocate UniaxialMaterial* array\n";
      return -1;
    }
    for (int i = 0; i < 4; i++) {
      ...
      if (theMaterial[i] == 0) {
	     opserr << "FAPrestressConcretePlaneStress::recvSelf() - Broker could not create NDMaterial of class type " << matClassTag << endln;
	     return -1;
      }
      ...
      if (res < 0) {
         opserr << "FAPrestressConcretePlaneStress::recvSelf() - material " << i << "failed to recv itself\n";
	     return res;
      }
    }
  }
  ...
  // materials exist , ensure materials of correct type and recvSelf on them
    ...
    for (int i = 0; i < 4; i++) {
      ...
      if (theMaterial[i]->getClassTag() != matClassTag) {
	     ...
	     theMaterial[i] = theBroker.getNewUniaxialMaterial(matClassTag);
	     if (theMaterial[i] == 0) {
            opserr << "FAPrestressConcretePlaneStress::recvSelf() - material " << i << "failed to create\n";
	        return -1;
		 }
	  }
...
int FAPrestressConcretePlaneStress::determineTrialStress(void)
{ 
	...
	else // Tstrain[0] != Tstrain[1]
	{
		...
		{
			opserr << "FAPrestressConcretePlaneStress::determineTrialStress: Failure to calculate citaR\n";
	...
	if ( status == 0 ) // does not get converged after iteration
	{
	  ...
	  // if ( minError > 0.05 )
	  //    opserr << "FAPrestressConcretePlaneStress::determineTrialStress: Warning, failure to get converged principal stress direction\n";
    } 
...
double FAPrestressConcretePlaneStress::getAngleError(double inputCita)
{
	double pi = 3.14159265359;
	double outputCita;
...
double FAPrestressConcretePlaneStress::getPrincipalStressAngle(double inputAngle)
{   
...
*/
	...
	{
    	opserr << "FAPrestressConcretePlaneStress::getPrincipalStressAngle: failure to get Hsu/Zhu ratio!\n";
	}
	...
	if ( v12*v21==1.0 )
	{
		opserr << "FAPrestressConcretePlaneStress::getPrincipalStressAngle: failure to get matrix [V]!\n";
	...
	else // Tstrain[0] != Tstrain[1]
	{
		...
		{
			opserr << "FAPrestressConcretePlaneStress::getPrincipalStressAngle: Failure to calculate principal stress direction\n";
