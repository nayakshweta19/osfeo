...
static int numConcreteMcftNonlinear5Materials = 0;

OPS_Export void *
OPS_NewConcreteMcftNonlinear5Material()
{
  if (numConcreteMcftNonlinear5Materials == 0) {
    numConcreteMcftNonlinear5Materials++;
  }
  ...
  theMaterial = new ConcreteMcftNonLinear5(tag, dData[0], dData[1], dData[2], dData[3], dData[4], dData[5], dData[6], dData[7]);
