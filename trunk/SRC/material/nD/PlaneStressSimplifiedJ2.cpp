...
# define ND_TAG_PlaneStressSimplifiedJ2   57573
...
PlaneStressSimplifiedJ2::PlaneStressSimplifiedJ2(int pTag,
  ...
  : NDMaterial(pTag, ND_TAG_PlaneStressSimplifiedJ2), stress(3),
...
int 
PlaneStressSimplifiedJ2::setTrialStrainIncr(const Vector &v)
{
  // ----- change to real strain instead of eng. strain
...
const Matrix & 
PlaneStressSimplifiedJ2::getTangent(void)
{
  return theTangent;
};

const Matrix & 
PlaneStressSimplifiedJ2::getInitialTangent(void)
{
  return this->getTangent();
};

const Vector & 
PlaneStressSimplifiedJ2::getStress(void)
{
  return stress;
};

const Vector & 
PlaneStressSimplifiedJ2::getStrain(void)
{
  return strain;
};

const Vector & 
PlaneStressSimplifiedJ2::getCommittedStress(void)
{
  return Cstress;
};

const Vector & 
PlaneStressSimplifiedJ2::getCommittedStrain(void)
{
  return Cstrain;
};

int 
PlaneStressSimplifiedJ2::commitState(void)
{
...
int 
PlaneStressSimplifiedJ2::revertToLastCommit(void)
{
  // -- to be implemented.
  return 0;
};
...
int 
PlaneStressSimplifiedJ2::revertToStart(void) 
{
  // -- to be implemented.
  return 0;
}
...
NDMaterial * 
PlaneStressSimplifiedJ2::getCopy(void)
{
...
NDMaterial * 
PlaneStressSimplifiedJ2::getCopy(const char *type)
{
...
int 
PlaneStressSimplifiedJ2::recvSelf(int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
  // -- to be implemented.
  return 0;
};
...
Response * 
PlaneStressSimplifiedJ2::setResponse(const char **argv, int argc, OPS_Stream &s)
{
...
void 
PlaneStressSimplifiedJ2::Print(OPS_Stream &s, int flag)
{
  // -- to be implemented.
  return;
};
