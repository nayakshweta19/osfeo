...
#define STEEL_Z02_DEFAULT_AC        1.9
#define STEEL_Z02_DEFAULT_RC       10.0
#define LOOP_NUM_LIMIT               30
const int SIZE = LOOP_NUM_LIMIT; //limit of array number

class SteelZ02 : public UniaxialMaterial
{
  public:
    SteelZ02(int tag, double fy, double E0, double fpc, double rou,
		     double ac = STEEL_Z02_DEFAULT_AC,
			 double rc = STEEL_Z02_DEFAULT_RC);
    SteelZ02();
    ~SteelZ02();
