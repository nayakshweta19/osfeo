...
#ifndef CSMMRCPlateFiber_h
#define CSMMRCPlateFiber_h

// $Revision: 1.2 $
// $Date: 2003/02/14 23:00:47 $
// $Source: /usr/local/cvs/OpenSees/SRC/material/nD/CSMMRCPlateFiber.h,v $
// File: CSMMRCPlateFiber.h
//
// Written: Li Ning (neallee@tju.edu.cn)
// Created: 2010.11
//
// Description: This file contains the class definition for 
// CSMMRCPlateFiber material.
...
class CSMMRCPlateFiber : public NDMaterial
{
  public:
    CSMMRCPlateFiber ( int      tag, 
				      double   RHO,
				      UniaxialMaterial *s1,
				      UniaxialMaterial *s2,
				      UniaxialMaterial *c1,
