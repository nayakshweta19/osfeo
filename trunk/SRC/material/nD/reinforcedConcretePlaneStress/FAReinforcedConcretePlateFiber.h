#ifndef FAReinforcedConcretePlateFiber_h
#define FAReinforcedConcretePlateFiber_h
...
class FAReinforcedConcretePlateFiber : public NDMaterial
{
  public:
    FAReinforcedConcretePlateFiber ( int      tag, 
				      double   RHO,
				      UniaxialMaterial *s1,
				      UniaxialMaterial *s2,
				      UniaxialMaterial *c1,
