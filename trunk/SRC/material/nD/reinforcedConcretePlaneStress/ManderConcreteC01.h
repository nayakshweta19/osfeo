...
// $Source: ManderConcreteC01.h,v $
                                                                        
#ifndef ManderConcreteC01_h
#define ManderConcreteC01_h
...
//
// What: "@(#) ManderConcreteC01.h, revA"

#include <UniaxialMaterial.h>

#define MAT_TAG_ManderConcreteC01 58645

class ManderConcreteC01 : public UniaxialMaterial
{
  public:
	ManderConcreteC01(int tag, double ifcc, double iecc, double iEc, double irn_pre, double irn_post, double ift, double iet, double irp, double ixp_cr, double ixn_cr);
    ManderConcreteC01();    
