...
#include "ParallelDRMInputHandler.h"

Vector ParallelDRMInputHandler::Vtm2(24);
Vector ParallelDRMInputHandler::Vtm1(24);
Vector ParallelDRMInputHandler::Vtp1(24);
Vector ParallelDRMInputHandler::Vtp2(24);


Vector ParallelDRMInputHandler::Vtm2_n1(3);
Vector ParallelDRMInputHandler::Vtm2_n2(3);
Vector ParallelDRMInputHandler::Vtm2_n3(3);
Vector ParallelDRMInputHandler::Vtm2_n4(3);
  
Vector ParallelDRMInputHandler::Vtm1_n1(3);
Vector ParallelDRMInputHandler::Vtm1_n2(3);
Vector ParallelDRMInputHandler::Vtm1_n3(3);
Vector ParallelDRMInputHandler::Vtm1_n4(3);

Vector ParallelDRMInputHandler::Vtp1_n1(3);
Vector ParallelDRMInputHandler::Vtp1_n2(3);
Vector ParallelDRMInputHandler::Vtp1_n3(3);
Vector ParallelDRMInputHandler::Vtp1_n4(3);

Vector ParallelDRMInputHandler::Vtp2_n1(3);
Vector ParallelDRMInputHandler::Vtp2_n2(3);
Vector ParallelDRMInputHandler::Vtp2_n3(3);
Vector ParallelDRMInputHandler::Vtp2_n4(3);

Vector ParallelDRMInputHandler::Vtempm2(3);
Vector ParallelDRMInputHandler::Vtempm1(3);
Vector ParallelDRMInputHandler::Vtempp1(3);
Vector ParallelDRMInputHandler::Vtempp2(3);





ParallelDRMInputHandler::ParallelDRMInputHandler(int tag, char** in_files, int files,  double dt, double* time_array,
...
ParallelDRMInputHandler::~ParallelDRMInputHandler()
{
  delete [] f1buffer;
  delete [] f2buffer;
  delete [] f3buffer;
...
void ParallelDRMInputHandler::populateBuffers()
{
  int pid;
  bool debug = false;
...
void ParallelDRMInputHandler::getMotions(Element* eletag, double time, Vector& U, Vector& Ud, Vector& Udd)
{
...
void ParallelDRMInputHandler::computeHistory(Element* eletag, double time, Vector& U, Vector& Ud, Vector& Udd, bool updateDm1) 
{
  // account for units of input versus model units cm -> m
  double scaleFactor = 0.01;
  double oneOverTwodt = 0.5/deltaT;
  ...
  Udd = (1.0 -mt)*oneOverTwodt*(Vtp1-Vtm2) + mt*oneOverTwodt*(Vtp2-Vtm1);
...
void ParallelDRMInputHandler::handle_elementAtface5(Element* eletag, double time, Vector& U, Vector& Ud, Vector& Udd) 
{
...
void ParallelDRMInputHandler::handle_elementAtface1(Element* eletag, double time, Vector& U, Vector& Ud, Vector& Udd) 
{
  bool updateDm1 =  false;
  Node** nodes = eletag->getNodePtrs();
  int index = getIndex(time);
...
void ParallelDRMInputHandler::handle_elementAtface2(Element* eletag, double time, Vector& U, Vector& Ud, Vector& Udd)
{
  bool updateDm1 =  false;
  Node** nodes = eletag->getNodePtrs();
  int index = getIndex(time);	
...
void ParallelDRMInputHandler::handle_elementAtface3(Element* eletag, double time, Vector& U, Vector& Ud, Vector& Udd)
{
  bool updateDm1 =  false;
  Node** nodes = eletag->getNodePtrs();
  int index = getIndex(time);
...
void ParallelDRMInputHandler::handle_elementAtface4(Element* eletag, double time, Vector& U, Vector& Ud, Vector& Udd)
{
  bool updateDm1 =  false;
  Node** nodes = eletag->getNodePtrs();
  int index = getIndex(time);
...
void ParallelDRMInputHandler::getLocations(double x, double y, double dx, double dy, int* xloc, int* yloc)
{
  *xloc = floor(x/dx);
  *yloc = floor(y/dy);
}

void ParallelDRMInputHandler::getTemporal(double time, int* tloc)
{
  *tloc = floor(time/deltaT);
}

int ParallelDRMInputHandler::getIndex(double time)
{
  // kill roundoffs
...
void ParallelDRMInputHandler::getf5pointer(Node* node_tag, int local_tag, int index)
{
...
void ParallelDRMInputHandler::getf1pointer(Node* node_tag, int local_tag, int index)
{
...
void ParallelDRMInputHandler::getf2pointer(Node* node_tag, int local_tag, int index)
{
  const Vector& crd = node_tag->getCrds();
  double x = crd(0);
  double y = crd(1);
...
void ParallelDRMInputHandler::getf3pointer(Node* node_tag, int local_tag, int index)
{
  const Vector& crd = node_tag->getCrds();
  double x = crd(0);
  double y = crd(1);
...
void ParallelDRMInputHandler::getf4pointer(Node* node_tag, int local_tag, int index)
{
  bool debug = false;
  const Vector& crd = node_tag->getCrds();
  double x = crd(0);
...
void ParallelDRMInputHandler::pointerCopy(int node_from, int node_to)
{
...
void ParallelDRMInputHandler::populateTempBuffers(int index, int fileptr, double ksi, double eta)
{
  //num nodes in file
