...
#ifndef ParallelDRMInputHandler_h
#define ParallelDRMInputHandler_h
...
class ParallelDRMInputHandler : public DRMInputHandler {
  
 public:
    
  ParallelDRMInputHandler(int tag, char** in_files, int files,  double dt, double* time_array, 
  ...
  virtual ~ParallelDRMInputHandler();
