...
const Matrix&  ShellMITC4Thermal::getInitialStiff( ) 
{
  ...
  //---------B-matrices------------------------------------
    ...
    static Matrix Bmembrane(3,3) ; // Modifed by J.Jiang
...
ShellMITC4Thermal::formResidAndTangent( int tang_flag ) 
{
  ...
  //---------B-matrices------------------------------------
    ...
    //static Matrix Bmembrane(3,2) ; // membrane B matrix
    static Matrix Bmembrane(3,3) ; // Modified by J.Jiang
  ...
  for ( i = 0; i < ngauss; i++ ) {
    ...
    //success = materialPointers[i]->setTrialSectionDeformation( strain ) ;    //Commented by J.Jiang
                               ...
                               const Matrix &Bshear ) 
{
  ...
  //Matrix Bmembrane(3,2) ; // plate membrane B matrix
    ...
    static Matrix Gmem(3,3) ;    //Modified by J.Jiang,UoE
	static Matrix Gbend(2,3);    //Added by J.Jiang,UoE
...
//
    ...
    //Matrix &Gbend = Gmem ;  //Commented by J.Jiang,UoE
...
ShellMITC4Thermal::computeBmembrane( int node, const double shp[3][4] ) 
{
 ...
 // static Matrix Bmembrane(3,2) ;
   static Matrix Bmembrane(3,2) ;  //Modified by J.Jiang,UoE
