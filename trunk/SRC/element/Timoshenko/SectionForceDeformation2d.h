...
// $Source: /usr/local/cvs/OpenSees/SRC/element/Timoshenko/SectionForceDeformation2d.h,v $
                                                                        
                                                                        
#ifndef SectionForceDeformation2d_h
#define SectionForceDeformation2d_h
...
//
// What: "@(#) SectionForceDeformation2d.h, revA"
...
class SectionForceDeformation2d : public Material
{
 public:
  SectionForceDeformation2d (int tag, int classTag);
  SectionForceDeformation2d ();
  virtual ~SectionForceDeformation2d ();
  ...
  virtual SectionForceDeformation2d *getCopy (void) = 0;
