// $Source: /usr/local/cvs/OpenSees/SRC/element/Timoshenko/FASTMFiberSection2d.h,v $
// $Revision: 1.1 $
...
#ifndef FASTMFiberSection2d_h
#define FASTMFiberSection2d_h
...
class FASTMFiberSection2d : public SectionForceDeformation
{
  public:
    FASTMFiberSection2d(); 
    FASTMFiberSection2d(int tag, 
		      int numFibers, 
		      Fiber **fibers, 
		      int numHFibers, 
		      Fiber **Hfibers, 
	...
	const char *getClassType(void) const {return "FASTMFiberSection2d";};

    int   setTrialSectionDeformation(const Vector &deforms); 
    int   setTrialSectionDeformation(const Vector &deforms, double L); 
    const Vector &getSectionDeformation (void);
    int   revertToLastCommit(double L);    
