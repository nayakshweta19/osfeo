// $Source: /usr/local/cvs/OpenSees/SRC/element/Timoshenko/RASTMFiberSection2d.h,v $
// $Revision: 1.1 $
...
#ifndef RASTMFiberSection2d_h
#define RASTMFiberSection2d_h
...
class RASTMFiberSection2d : public SectionForceDeformation
{
  public:
    RASTMFiberSection2d(); 
    RASTMFiberSection2d(int tag, 
		      int numFibers, 
		      Fiber **fibers, 
		      int numHFibers, 
		      Fiber **Hfibers, 
	...
	const char *getClassType(void) const {return "RASTMFiberSection2d";};
