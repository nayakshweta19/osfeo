...
// $Source: /usr/local/cvs/OpenSees/SRC/element/forceBeamColumn/GaussQBeamIntegration.cpp,v $
...
GaussQBeamIntegration::GaussQBeamIntegration():
  BeamIntegration(BEAM_INTEGRATION_TAG_GaussQ)
{
  // Nothing to do
}
...
{
  return new GaussQBeamIntegration();
}

void
GaussQBeamIntegration::getSectionLocations(int numSections, 
					    double L,
					    double *xi)
{
  switch(numSections) {
  ...
  default:
    opserr << "GaussQBeamIntegration -- max # integration points is 10\n";
    break;
