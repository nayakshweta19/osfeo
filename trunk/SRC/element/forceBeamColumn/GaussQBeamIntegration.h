...
// $Source: /usr/local/cvs/OpenSees/SRC/element/forceBeamColumn/GaussQBeamIntegration.h,v $

#ifndef GaussQBeamIntegration_h
#define GaussQBeamIntegration_h
...
class GaussQBeamIntegration : public BeamIntegration
{
 public:
  GaussQBeamIntegration();
  virtual ~GaussQBeamIntegration();
