...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTSTLGMBeamColumn3D.h,v $


// File: ~/model/element/RCFTSTLGMBeamColumn3D.h

#ifndef RCFTSTLGMBeamColumn3D_h
#define RCFTSTLGMBeamColumn3D_h
...
class RCFTSTLGMBeamColumn3D: public Element
{
  public:
    RCFTSTLGMBeamColumn3D ();
    RCFTSTLGMBeamColumn3D (int tag, int nodeI, int nodeJ,
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, RCFTSTLGMBeamColumn3D &E);
