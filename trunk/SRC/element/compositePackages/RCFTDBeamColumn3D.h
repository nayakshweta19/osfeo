...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTDBeamColumn3D.h,v $


// File: ~/model/element/RCFTDBeamColumn3D.h

#ifndef RCFTDBeamColumn3D_h
#define RCFTDBeamColumn3D_h
...
class RCFTDBeamColumn3D: public Element
{
  public:
    RCFTDBeamColumn3D ();
    RCFTDBeamColumn3D (int tag, int nodeI, int nodeJ,
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, RCFTDBeamColumn3D &E);
