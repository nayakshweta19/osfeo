...
// $Revision: 1.1.1.1 $
// $Date: 2007-09-21 15:28:20 $
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTMBeamColumn3D.h,v $


// File: ~/model/element/RCFTMBeamColumn3D.h

#ifndef RCFTMBeamColumn3D_h
#define RCFTMBeamColumn3D_h
...
class RCFTMBeamColumn3D: public Element
{
  public:
    RCFTMBeamColumn3D ();
    RCFTMBeamColumn3D (int tag, int nodeI, int nodeJ,
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, RCFTMBeamColumn3D &E);
