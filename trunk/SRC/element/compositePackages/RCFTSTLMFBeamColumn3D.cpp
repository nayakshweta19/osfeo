...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTSTLMFBeamColumn3D.cpp,v $
...
#include <Parameter.h>
#include <RCFTSTLMFBeamColumn3D.h>
...
Matrix RCFTSTLMFBeamColumn3D::theMatrix(12,12);
Vector RCFTSTLMFBeamColumn3D::theVector(12);
double RCFTSTLMFBeamColumn3D::workArea[400];

// constructor:
// invoked by a FEM_ObjectBroker, recvSelf() needs to be invoked on this object.
// CONSTRUCTOR FOR PARALLEL PROCESSING

RCFTSTLMFBeamColumn3D::RCFTSTLMFBeamColumn3D():
Element(0,ELE_TAG_RCFTSTLMFBeamColumn3D), connectedExternalNodes(2),
...
RCFTSTLMFBeamColumn3D::RCFTSTLMFBeamColumn3D (int tag, int nodeI, int nodeJ,
                                      int numSec, RCFTSTLFiberSection3D **sec,
                                      BeamIntegration &bi,
                                      CrdTransf &coordTransf, double massDensPerUnitLength):
Element(tag,ELE_TAG_RCFTSTLMFBeamColumn3D), connectedExternalNodes(2),
beamIntegr(0), numSections(0), sections(0), crdTransf(0),
...
int
RCFTSTLMFBeamColumn3D::getNumExternalNodes(void) const
{
   return 2;
}
...
const ID &
RCFTSTLMFBeamColumn3D::getExternalNodes(void)
{
...
Node **
RCFTSTLMFBeamColumn3D::getNodePtrs(void)
{
   return theNodes;
}

int
RCFTSTLMFBeamColumn3D::getNumDOF(void)
{
   return NEGD;
}
...
void
RCFTSTLMFBeamColumn3D::setDomain(Domain *theDomain)
{
...
int RCFTSTLMFBeamColumn3D::revertToLastCommit()
{
   int err;
   int i = 0;
...
int RCFTSTLMFBeamColumn3D::revertToStart()
{
...
const Matrix &
RCFTSTLMFBeamColumn3D::getInitialStiff(void)
{
  //ofstream newton; 
...
const Vector &
RCFTSTLMFBeamColumn3D::getResistingForce(void)
{
  return Sglobal;
}
...
//  Vector p0(12);
//  p0.Zero();
//  Sglobal = crdTransf->getGlobalResistingForce(Sg, p0);
//  return Sglobal;
//}

void RCFTSTLMFBeamColumn3D::calcResistingForce(void)
{
  //ofstream unbal;
  //unbal.open("mpls.dat",ios::app);
  crdTransf->update();
  Vector p0(12);
  p0.Zero();
...
void
RCFTSTLMFBeamColumn3D::initializeSectionHistoryVariables (void)
{
    for (int i = 0; i < numSections; i++){
	ksa[i]       = Matrix(4,4);
        fsa[i]       = Matrix(4,4);
...
int RCFTSTLMFBeamColumn3D::update()
{
  //ofstream geom;
  ...
  for( i = 0; i < numSections; i++ ){
     ...
     //mpls>>nd1Tf[i];
     /************************************************************************/
     /* CALCULATE THE GAUSSIAN INTEGRATION FOR THE UNBALANCE OF COMPATIBILITY*/
     /************************************************************************/
     for( j = 0; j < 5; j++ ){
        for( k = 0; k < 5; k++ ){
             H(j,k) = H(j,k) + L * wt[i] * nd1Tfnd1[i](j,k);
        }
     }
  }
  ...
  //lstiff<<"\n update unreduced stiffness matrix"<<endl;
...
const Matrix &
RCFTSTLMFBeamColumn3D::getMass(void)
{
  theMatrix.Zero();
...
void
RCFTSTLMFBeamColumn3D::zeroLoad(void)
{
	
}

int
RCFTSTLMFBeamColumn3D::addLoad(ElementalLoad *theLoad, double loadFactor)
{
  return 0;
}
...
int
RCFTSTLMFBeamColumn3D::addInertiaLoadToUnbalance(const Vector &accel)
{
  return 0;
}

const Vector &
RCFTSTLMFBeamColumn3D::getResistingForceIncInertia()
{
...
bool
RCFTSTLMFBeamColumn3D::isSubdomain(void)
{
    return false;
}
...
void
RCFTSTLMFBeamColumn3D::Print(OPS_Stream &s, int flag)
{
   if (flag == 1)
   {
...
OPS_Stream &operator<<(OPS_Stream &s, RCFTSTLMFBeamColumn3D &E)
{
    E.Print(s);
    return s;
}
...
int
RCFTSTLMFBeamColumn3D::displaySelf(Renderer &theViewer, int displayMode, float fact)
{
...
Response*
RCFTSTLMFBeamColumn3D::setResponse(char **argv, int argc, Information &eleInformation)
{
    // global force -
...
int
RCFTSTLMFBeamColumn3D::getResponse(int responseID, Information &eleInfo)
{
    switch (responseID) {
...
int
RCFTSTLMFBeamColumn3D::setParameter (const char **argv, int argc, Parameter &param)
{
...
int
RCFTSTLMFBeamColumn3D::updateParameter (int parameterID, Information &info)
{
...
void
RCFTSTLMFBeamColumn3D::setSectionPointers(int numSec, RCFTSTLFiberSection3D **secPtrs)
{
...
const Vector& 
RCFTSTLMFBeamColumn3D::getBasicIncrDisp(void)
{
    return ub;									    
}	
...
Vector
RCFTSTLMFBeamColumn3D::getBasicIncrDeltaDisp(void)
{
   //ofstream output;
...
Vector
RCFTSTLMFBeamColumn3D::getd_hat(int sec, const Vector &v)
{
   //ofstream newton;
   ...
   D_hat(0) =  temp_C*v(0) + temp_D*v(5) +
               v(1)*v(1)*L/15 - v(3)*v(1)*L/30 + v(3)*v(3)*L/15 +
               v(2)*v(2)*L/15 - v(4)*v(2)*L/30 + v(4)*v(4)*L/15;               
...
Matrix
RCFTSTLMFBeamColumn3D::getNld_hat(int sec, const Vector &v)
{
   //ofstream newton;
...
Matrix
RCFTSTLMFBeamColumn3D::getNd1(int sec, const Vector &v)
{
    //ofstream newton;
    //newton.open("newton.dat",ios::app);
...
void RCFTSTLMFBeamColumn3D::calcDeformedLength(void)
{
...
double RCFTSTLMFBeamColumn3D::getDeformedLength(void)
{
   return deflength; 
}

int
RCFTSTLMFBeamColumn3D::sendSelf(int commitTag, Channel &theChannel)
{  
  return 0;
}
    
int
RCFTSTLMFBeamColumn3D::recvSelf(int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
  return 0;
}
