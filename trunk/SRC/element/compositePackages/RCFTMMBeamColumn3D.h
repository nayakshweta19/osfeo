...
// $Revision: 1.1.1.1 $
// $Date: 2007-09-21 15:28:23 $
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/OpenSEESComp/OpenSees/SRC/element/RCFTMMBeamColumn3D.h,v $


// File: ~/model/element/RCFTMMBeamColumn3D.h

#ifndef RCFTMMBeamColumn3D_h
#define RCFTMMBeamColumn3D_h
...
class RCFTMMBeamColumn3D: public Element
{
  public:
    RCFTMMBeamColumn3D ();
    RCFTMMBeamColumn3D (int tag, int nodeI, int nodeJ,
    ...
    friend OPS_Stream &operator<<(OPS_Stream &s, RCFTMMBeamColumn3D &E);
