...
element  dispBeamColumn       1       1       2     5     2     1  -mass +4.665600E+005  -iter   20  +1.000000E-004 

# Element "Beam":    eleTag    NodeI    NodeJ    NIP    secTag    geoTranTag    <-mass massDens>    <-iter maxIters tol> 
element  dispBeamColumn       2       2       3     5     2     1  -mass +4.665600E+005  -iter   20  +1.000000E-004 

# Element "Beam":    eleTag    NodeI    NodeJ    NIP    secTag    geoTranTag    <-mass massDens>    <-iter maxIters tol> 
element  dispBeamColumn       3       3       4     5     2     1  -mass +4.665600E+005  -iter   20  +1.000000E-004 
...
set iDmax { 5 10 20 30 40 50 60 70 } ; ##20 25 30 35 40 45 50 60 70 80 100 120 140 160 240 };  # vector of displacement-cycle peaks, in terms of storey drift ratio
