...
uniaxialMaterial MCFTSteel01 11 $wfyv $wE $wfc $rou1
uniaxialMaterial MCFTSteel01 12 $wfyh1 $wE $wfc $rou2
...
nDMaterial MCFTRCPlaneStress $PlaneStressMatTag 0.0 11 12 14 15 [expr 0.0*$pi] [expr 0.5*$pi] $rou1 $rou2 $db1 $db2 $wfc $wfyv $wE 0.002 10 140 140
