...
#forceBeamColumn $eleTag $iNode $jNode $numIntgrPts $testSecTag $transfTag
#element nonlinearBeamColumn 2001 1001 1002 $np $testSecTag $transfTag;
element dispBeamColumn 2001 1001 1002 $np $testSecTag $transfTag;
#element Timoshenko2d01 2001 1001 1002 $np $testSecTag $transfTag;
...
#element beamWithHinges $eleTag $iNode $jNode $testSecTag $Lpi $testSecTag $Lpj $E $A $Iz $transfTag
