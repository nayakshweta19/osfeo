...
test NormDispIncr 1.e-1 100 5
# Creating the solution algorithm
algorithm KrylovNewton
# Creating the integration scheme, the DisplacementControl scheme
#integrator DisplacementPath 66 2 1 numStep 2000 increment -0.01
integrator DisplacementControl 66 2 1.0
...
recorder Node -file B1_disp_Output.out -time -node 3 9 15 -dof 2 disp
# perform the analysis
set numStEps   {2000 };
set numIters   { 10 };
set increments { 1.0 };
...
for {set i 0} {$i<14} {incr i 1} {
    ...
    integrator DisplacementControl 66 2 $increment
    if {$numIter == 0} {
	set numIter 1
    } 
