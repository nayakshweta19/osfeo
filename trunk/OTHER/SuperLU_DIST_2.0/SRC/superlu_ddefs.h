...
extern void  pdgssvx_ABglobal(superlu_options_t_Distributed *, SuperMatrix *, 
...
extern int_t pddistribute(fact_t, int_t, SuperMatrix *, 
			 ...
			 LUstruct_t *, gridinfo_t *);
extern void  pdgssvx(superlu_options_t_Distributed *, SuperMatrix *, 
		     ScalePermstruct_t *, double *,
		     int, int, gridinfo_t *, LUstruct_t *,
		     SOLVEstruct_t *, double *, SuperLUStat_t *, int *);
extern int  dSolveInit(superlu_options_t_Distributed *, SuperMatrix *, int_t [], int_t [],
		       int_t, LUstruct_t *, gridinfo_t *, SOLVEstruct_t *);
extern void pxgstrs_finalize(pxgstrs_comm_t *);
extern void dSolveFinalize(superlu_options_t_Distributed *, SOLVEstruct_t *);
...
extern int  pdgsmv_AXglobal_abs(int_t, int_t [], double [], int_t [],
				 double [], double []);
extern void pdgsmv_init(SuperMatrix *, int_t *, gridinfo_t *, SuperMatrix *,
			pdgsmv_comm_t *);
...
extern int_t dQuerySpace_dist(int_t, LUstruct_t *, gridinfo_t *, mem_usage_t_Distributed *);
