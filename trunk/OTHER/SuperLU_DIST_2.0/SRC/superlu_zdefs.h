...
extern void
zCompRow_to_CompCol(int_t, int_t, int_t, doublecomplex *, int_t *, int_t *,
...
extern void  pzgssvx_ABglobal(superlu_options_t_Distributed *, SuperMatrix *, 
...
extern int_t pzdistribute(fact_t, int_t, SuperMatrix *, 
			 ...
			 LUstruct_t *, gridinfo_t *);
extern void  pzgssvx(superlu_options_t_Distributed *, SuperMatrix *, 
		     ScalePermstruct_t *, doublecomplex *,
		     int, int, gridinfo_t *, LUstruct_t *,
		     SOLVEstruct_t *, double *, SuperLUStat_t *, int *);
extern int  zSolveInit(superlu_options_t_Distributed *, SuperMatrix *, int_t [], int_t [],
		       int_t, LUstruct_t *, gridinfo_t *, SOLVEstruct_t *);
extern void pxgstrs_finalize(pxgstrs_comm_t *);
extern void zSolveFinalize(superlu_options_t_Distributed *, SOLVEstruct_t *);
extern void zldperm(int_t, int_t, int_t, int_t [], int_t [],
		    doublecomplex [], int_t *, double [], double []);
extern void pdgstrf(superlu_options_t_Distributed *, int, int, double,
...
extern void pzgsmv_init(SuperMatrix *, int_t *, gridinfo_t *, SuperMatrix *,
			pzgsmv_comm_t *);
...
extern int_t zQuerySpace_dist(int_t, LUstruct_t *, gridinfo_t *, mem_usage_t_Distributed *);
