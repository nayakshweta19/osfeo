...
)
{
    ...
    /* ------------------------------------------------------------
       ...
       ------------------------------------------------------------*/
    zCompRow_to_CompCol(m_loc, n, nnz_loc, a, colind, rowptr, &a_loc, 
 ...
 */
int zSolveInit(superlu_options_t_Distributed *options, SuperMatrix *A, 
	       ...
	       SOLVEstruct_t *SOLVEstruct)
{
	...
	pzgsmv_init(A, row_to_proc, grid, &A_loc, SOLVEstruct->gsmv_comm);
 ...
 */
void zSolveFinalize(superlu_options_t_Distributed *options, SOLVEstruct_t *SOLVEstruct)
{
